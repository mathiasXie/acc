...
type CloudConfig struct {
	...
	Namespace   string `gorm:"column:namespace;type:varchar(180);index:idx_namespace_config_key,unique;index:uni_namespace_config_enable,unique" json:"namespace"`
	ConfigKey   string `gorm:"column:config_key;type:varchar(180);index:idx_namespace_config_key,unique;index:uni_namespace_config_enable,unique" json:"config_key"`
	...
	Enabled bool  `gorm:"column:enabled;type:tinyint(1);default:0;index:uni_namespace_config_enable,unique" json:"enabled"`
